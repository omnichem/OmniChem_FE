...
const ErrorPage: React.FC<ErrorPageProps> = () => {
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', flexDirection: 'column' }}>
      <img src="https://www.google.com/images/errors/robot.png" alt="Error Robot" style={{ width: '150px', marginBottom: '20px' }} />
      <h1 style={{ fontSize: '24px', fontWeight: 'bold', color: '#333' }}>Упс! Что-то пошло не так.</h1>
      <p style={{ fontSize: '16px', color: '#666' }}>Пожалуйста, попробуйте обновить страницу или обратитесь в службу поддержки.</p>
