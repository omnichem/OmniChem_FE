  ...
  return (
    <div className="marketView">
      <div className="ellips-block">
        <img className="Ellipse" src={ellips21} alt="фон" />
            ...
            <div className="future-Content__inner">
              <div className="future-Content__leftBlock">
                <p className="leftBlock-txt">
                  Мы в <span className="omnichem"> omnichem </span> уверены, что
                  химическая отрасль это драйвер развития любой другой отрасли.
                  Мы считаем, что простой и открытый доступ к информации о сырье
                  позволяет вам работать эффективнее и быстрее, чтобы вы могли
                  разрабатывать новые продукты и улучшать свои бизнес
                  показатели.
                </p>
              </div>
              <div className="future-Content__rightBlock">
                <p className="rightBlock-upTxt">
                  Благодаря вам развивается производство автомобилей и лекарств.
                  Повышается эффективность сельского хозяйства. Появляются
                  инновационные косметические средства и биоразлагаемая
                  упаковка. Повышается технологическая независимость и
                  продовольственный суверенитет. Это лишь малая часть отраслей в
                  развитии которых участвует химия.
                </p>
                <p className="rightBlock-downTxt">
                  Нам не терпится увидеть, какие еще отрасли начнут развиваться
                  быстрее с появлением omnichem.
                </p>
              </div>
            </div>
          </div>
